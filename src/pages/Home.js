      ...
      <div className="relative z-10 h-full">
        <div className="container-custom h-full flex items-center">
          <div className="max-w-3xl">
            <h1 className="hero-readable-shadow text-white text-4xl font-extrabold leading-tight mb-6">
            ...
            <div className="flex gap-4">
              <a
                href={onCTAClick.whatsappUrl}
                onClick={onCTAClick.handleClick}
                className={`cta-split ${ctaAnimating ? 'cta-animating' : ''}`}
              >
...
const Home = () => {
  const phoneNumber = '5519997943929';
  const defaultMessage = encodeURIComponent('Olá, gostaria de falar sobre soluções financeiras');
    ...
    <div className="overflow-hidden">
      ...
      <section className="section-padding" style={{ background: '#f8f8f8' }}>
        <div className="container-custom">
          ...
          <h2 className="text-4xl font-extrabold text-center mb-3" style={{ color: 'var(--b4-gray)' }}>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-white">
              <h2 className="text-4xl font-extrabold mb-6" style={{
                color: '#ffffff',
                lineHeight: '1.2',
                letterSpacing: '-0.5px'
              }}>
